 ...
 */
@Slf4j
@Service("OpenMarginTrading")
public class OpenMarginTrading extends BaseExecutorTask {
	...
	private static final String MSGTHEMECODE = "OpenMarginTrading";
	
	private static final String LOG_TAG = "用户完成两融新开户任务";
	
	private static final String DATE_FORMATE = "yyyy-MM-dd";
	
	private static final Integer USER_TYPE = 3;
	private static final String SMS_LINK = "m.wlzq.cn/c?d4";
	private static final String SMS_CONTENT = "恭喜您获得炒股利器Level-2增强行情6个月免费体验资格，详情点 m.wlzq.cn/c?d4 拒收回T";
