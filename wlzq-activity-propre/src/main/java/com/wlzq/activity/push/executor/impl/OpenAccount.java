...
@Slf4j
@Service("OpenAccount")
public class OpenAccount extends BaseExecutorTask {
	...
	private static final String MSGTHEMECODE = "OpenAccount";
	
	private static final String LOG_TAG = "入金引导任务";
	...
	private static final String SMS_CONTENT = "尊敬的客户，首次入金达标即可免费体验3个月Level-2增强行情，详情点 m.wlzq.cn/c?d4 拒收回T";
